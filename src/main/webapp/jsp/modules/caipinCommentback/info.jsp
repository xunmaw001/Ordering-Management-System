                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="caipinCommentbackPingfenNumber" name="caipinCommentbackPingfenNumber" class="form-control"
                                               v-model="ruleForm.caipinCommentbackPingfenNumber" readonly>
                                    </div>


                                    <div class="form-group col-md-6">
                                        <label>评价内容</label>
                                        <input style="width: 450px" id="caipinCommentbackText" name="caipinCommentbackText" class="form-control"
                                               v-model="ruleForm.caipinCommentbackText" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "caipinCommentback/info/" + id,
