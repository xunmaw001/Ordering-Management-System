...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">配送地址管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">配送地址管理</li>
                            <li class="breadcrumb-item active">配送地址列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">配送地址列表</h3>
    ...
    //查询当前表搜索条件所有列表
        ...
        layui.use(['layer', 'carousel', 'jquery', 'form', 'upload', 'laydate', 'rate'], function () {
            ...
            rate.render({
                elem: '#addressCommentbackPingfenNumber'
                ,value: 3 //初始值
                ,text: true //开启文本
            });
