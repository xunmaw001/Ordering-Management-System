            ...
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    ...
                    <div class="travel-gallery-wrapper">
                        <div class="row">
                            <div v-for="(item,index) in caipinList" v-bind:key="index" class="col-md-3 col-sm-6 col-xs-6 col-lg-3">
                                <div class="single-gallery-item" @click="jumpCheck('../caipin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <div class="img-box">
                                        <img :src="item.caipinPhoto?item.caipinPhoto.split(',')[0]:''" style="height: 350px;width:100%;" />
                                        <b class="location" v-if="item.caipinNewMoney">
                                            {{item.caipinNewMoney}} RMB
                                        </b>
                                    ...
                                    <div class="content">
                                        <h5 class="catagory">
                                            <b style="color: inherit">{{item.caipinName}}</b>
                                        </h5>
                                    </div>
                                </div>
                            </div>
