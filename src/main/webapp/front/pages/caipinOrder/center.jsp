					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="caipinOrderUuidNumber" id="caipinOrderUuidNumber" lay-verify="required" placeholder="订单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="caipinOrderTruePrice" id="caipinOrderTruePrice"  lay-verify="required|double"   placeholder="实付价格" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="caipinOrderCourierName" id="caipinOrderCourierName" lay-verify="required" placeholder="送餐人姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="caipinOrderCourierNumber" id="caipinOrderCourierNumber" lay-verify="required" placeholder="送餐人手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="caipinOrderTypes" id="caipinOrderTypes">
                                    <option v-for="item in caipinOrderTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="caipinOrderPaymentTypes" id="caipinOrderPaymentTypes">
                                    <option v-for="item in caipinOrderPaymentTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="yuyuepeisongTime" id="yuyuepeisongTime"  lay-verify="required|date"   placeholder="预约配送时间" autocomplete="off" class="layui-input">
							</div>
						</div>
