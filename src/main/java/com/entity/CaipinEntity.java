...
public class CaipinEntity<T> implements Serializable {
     ...
     * 评分
     */
    @TableField(value = "caipin_pingfen")

    private Double caipinPingfen;
	 ...
	 * 设置：评分
	 */
    public Double getCaipinPingfen() {
    ...
    public void setCaipinPingfen(Double caipinPingfen) {
